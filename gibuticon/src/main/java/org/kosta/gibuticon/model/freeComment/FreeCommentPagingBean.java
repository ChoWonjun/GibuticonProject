 ...
 *
 */
public class FreeCommentPagingBean {
	/**
	 * 현재 페이지
	 */
	 ...
	 * @param nowPage
	 */
	public FreeCommentPagingBean(int totalContents,int nowPage){
	...
	public static void main(String args[]){         
		  FreeCommentPagingBean p=new FreeCommentPagingBean(47,1);
		  // 전체 페이지 수 : 10
		  System.out.println("getTotalPage:"+p.getTotalPage());    
		  // 전체 페이지 그룹 수 : 3
		  System.out.println("getTotalPageGroup:"+p.getTotalPageGroup()); 
		  p=new FreeCommentPagingBean(31,6);// 게시물수 31 현재 페이지 6
