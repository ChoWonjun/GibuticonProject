    ...
    function html5Upload() {	
        ...
        sUploadURL= 'http://localhost:8888/gibuticon-fileupload/multiplePhotoUpload.gibu';     //다중파일업로드 URL
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl : 'http://localhost:8888/gibuticon-fileupload/photoUpload.gibu', //파일업로드시 동작되는 컨트롤러 url
			sCallback : '/resource/editor/photo_uploader/popup/callback.html',//업로드 이후  redirect 페이지	
