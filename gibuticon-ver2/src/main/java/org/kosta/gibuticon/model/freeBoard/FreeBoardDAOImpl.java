...
public class FreeBoardDAOImpl implements FreeBoardDAO {
	 ...
	 * 
	 * @see
	 * org.kosta.gibuticon.model.board.FreeBoardDAO#getFreeBoardByNo(java.lang
	 * .String)
	 */
	/**
	...
	public FreeBoardVO getFreeBoardByNo(String no) {
		FreeBoardVO fvo = sqlSessionTemplate.selectOne(
				"freeBoard.getFreeBoardByNo", no);
		fvo.setMemberVO((MemberVO) sqlSessionTemplate.selectOne(
				"member.findMemberById", fvo.getId()));
		return fvo;
	}
	...
	public List<FreeBoardVO> getListBySearching(HashMap<String, Object> map) {
		return sqlSessionTemplate.selectList("freeBoard.getListBySearching",
				map);
	}
	...
	public List<FreeBoardVO> getListBySearchingMyId(HashMap<String, Object> map) {
		List<FreeBoardVO> list = sqlSessionTemplate.selectList(
				"freeBoard.getListBySearchingMyId", map);
	 ...
	 * 
	 * @see
	 * org.kosta.gibuticon.model.board.FreeBoardDAO#writeFreeBoard(org.kosta
	 ...
	 * 
	 * @see
	 * org.kosta.gibuticon.model.board.FreeBoardDAO#deleteFreeBoard(java.lang
	 * .String)
	 */
	/**
	 * 자유게시판에 있는 글을 삭제하는 메서드 이때 자유게시판은 코멘트보드와 연결되어 있기 때문에 우선적으로 코멘트보드를 다 지운후
	 * 자유게시판을 지운다.
	 */
	@Override
	public void deleteFreeBoard(String no) {
		List<FreeCommentVO> list = sqlSessionTemplate.selectList(
				"freeComment.deleteFreeCommentList", no);
		for (int i = 0; i < list.size(); i++) {
			sqlSessionTemplate.delete("freeComment.deleteFreeComment", list
					.get(i).getCommentNo());
		}
	 ...
	 * 
	 * @see
	 * org.kosta.gibuticon.model.board.FreeBoardDAO#updateFreeBoard(org.kosta
	 * .gibuticon.model.board.FreeBoardVO)
	 */
	/**
	...
	public int getTotalPostingCountByMyId(HashMap<String, Object> map) {
		return sqlSessionTemplate.selectOne(
				"freeBoard.getTotalPostingCountByMyId", map);
	}
	...
	/**
	 * 우선 답글 레벨을 올리고 그 후 답글을 작성하는 메서드
	 */
	@Override
	 ...
	 */
	@Override
	public void replyUpdate(FreeBoardVO freeBoardVO) {
