 ...
 *
 */
public class CommentPagingBean {
	/**
	 * 현재 페이지
	 */
	 ...
	 * @param nowPage
	 */
	public CommentPagingBean(int totalContents,int nowPage){
