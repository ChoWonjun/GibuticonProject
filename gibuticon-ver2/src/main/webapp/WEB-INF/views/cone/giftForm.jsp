...
선물대상
<input type="radio" name="target" value="friend"> 친구
<input type="radio" name="target" value="nonmem"> 비회원<br><br>
</form>
...
<div id="giftToMemberDiv">
	<form action="${initParam.root }cone/giftToMember.gibu" id="giftForm">
		선물하실 금액을 선택하세요.<br>
		50콘<input type="radio" name="price" value="50" checked="checked">&nbsp;
		100콘<input type="radio" name="price" value="100">&nbsp;
		200콘<input type="radio" name="price" value="200">&nbsp;<br>
		<input type="hidden" name="senderId" value="${sessionScope.mvo.id }"><br>
		친구를 선택하세요.<br>
