			...
			<div class="section" style="width:420px">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-4">
							<img
								src="${initParam.root}img\원준오빠.jpg"
								class="center-block img-circle img-responsive" style="width: 300px; height: 300px;">
							<h3 class="text-center">조원준</h3>
							<p class="text-center">Project Manager</p>
						</div>
						<div class="col-md-4">
							<img
								src="${initParam.root}img\효섭오빠.jpg"style="width: 300px; height: 300px;"
						...
						<div class="col-md-4">
							<img
								src="${initParam.root}img\경희.jpg"style="width: 300px; height: 300px;"
								class="center-block img-circle img-responsive">
						...
						<div class="col-md-4">
							<img
								src="${initParam.root}img\지현언니.jpg" style="width: 300px; height: 300px;"
								class="center-block img-circle img-responsive">
						...
						<div class="col-md-4">
							<img
								src="${initParam.root}img\임수현.png" style="width: 300px; height: 300px;"
								class="center-block img-circle img-responsive">
						...
						<div class="col-md-4">
							<img
								src="${initParam.root}img\강사님.jpg"style="width: 300px; height: 300px;"
								class="center-block img-circle img-responsive">
