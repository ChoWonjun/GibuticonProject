									...
									<div id="content_w">
										<div class="sectioin_mymain_bean2">
											...
											<div class="mymain_bean mymain_bean2">
												<img src="${initParam.root }img/나눔 랭킹.jpg" width="72"
													height="22" alt="나눔랭킹">
												<!-- 091222 수정 -->
												<img
												...
												<div class="bx_bg">
													<table cellpadding="0" cellspacing="0" summary="">
														...
														<tbody>
															...
															<tr>
																<th><img src="${initParam.root }img/콘 충전금액.jpg"
																	width="55" height="13" alt="콩 충전금액"></th>
									...
									<div class="row">
										...
										<div class="bean_subject">
											<a href="http://happybean.naver.com/my/CongAccount.nhn"><img
												src="${initParam.root }img/보유한콘.jpg" width="" height="20"
												alt="보유한 콘"></a> <img
												src="http://happyimg2.naver.net/img3/happybean/img/icon_folder_next.gif"
										...
										<div class="bean">
											...
											<div class="bean_subject">
												<h4>
													<a href="#"><img src="${initParam.root }img/기부한 콘.jpg"
