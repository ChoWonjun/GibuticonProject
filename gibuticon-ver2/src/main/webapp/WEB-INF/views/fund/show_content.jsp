	...
	function getCommentList(commentPage) {
		$
				.ajax({
					...
					data : "no=${requestScope.posting.fundNo}&commentPage="
							+ commentPage,
					success : function(comment) {
						...
						for (var i = 0; i < comment.list.length; i++) {
							...
							table += "<td>" + comment.list[i].commentNo
									+ "</td>";
							table += "<td>" + comment.list[i].text + "</td>";
							table += "<td>" + comment.list[i].commentTime
									+ "</td>";
							table += "<td>" + comment.list[i].memberVO.name
									+ "<br>(" + comment.list[i].memberVO.id
									+ ")</td>";
						...
						if (comment.pagingBean.previousPageGroup) {
							table += "<li>";
							table += "<a href='javascript:getCommentList("
									+ comment.pagingBean.startPageOfPageGroup
									- 1 + ")'>◀</a>";
							table += "</li>";
						}
						...
						for (var i = comment.pagingBean.startPageOfPageGroup; i <= comment.pagingBean.endPageOfPageGroup; i++) {
							table += "<a href='javascript:getCommentList(" + i
									+ ")'>" + i + "</a>";
						}
						table += "</li>";
						...
						if (comment.pagingBean.nextPageGroup) {
							table += "<li>";
							table += "<a href='javascript:getCommentList("
									+ comment.pagingBean.endPageOfPageGroup + 1
									+ ")'>▶</a>";
							table += "</li>";
						}
